# Description
* A very Python native model-data optimization toolchain derived from ***neuronunit*** core components and implemented in community supported python modules (neo,elephant) which are directly interfaced into a fast data driven optimization (numba, dask etc).
* A collection of compact, parsimonious biological neuronal models, implemented and interfaced with community preferred python modules and interfaced into a fast data driven muliti-objective optimization routine.
