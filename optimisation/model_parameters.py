...
BAE1['ADAPTATION_TIME_CONSTANT_tau_w'] = [0.75 * BAE1['ADAPTATION_TIME_CONSTANT_tau_w'], 1.5 * BAE1['ADAPTATION_TIME_CONSTANT_tau_w']]
BAE1['ADAPTATION_VOLTAGE_COUPLING_a'] = [0.75 * BAE1['ADAPTATION_VOLTAGE_COUPLING_a'], 1.5 * BAE1['ADAPTATION_VOLTAGE_COUPLING_a']]
BAE1['FIRING_THRESHOLD_v_spike'] = [0.75 * BAE1['FIRING_THRESHOLD_v_spike'], 1.5 * BAE1['FIRING_THRESHOLD_v_spike']]
BAE1['MEMBRANE_RESISTANCE_R'] = [0.75 * BAE1['MEMBRANE_RESISTANCE_R'], 1.5 * BAE1['MEMBRANE_RESISTANCE_R']]
BAE1['MEMBRANE_TIME_SCALE_tau_m'] = [0.75 * BAE1['MEMBRANE_TIME_SCALE_tau_m'], 1.5 * BAE1['MEMBRANE_TIME_SCALE_tau_m']]
BAE1['RHEOBASE_THRESHOLD_v_rh'] = [0.75 * BAE1['RHEOBASE_THRESHOLD_v_rh'], 1.5 * BAE1['RHEOBASE_THRESHOLD_v_rh']]
BAE1['SHARPNESS_delta_T'] = [0.75 * BAE1['SHARPNESS_delta_T'], 1.5 * BAE1['SHARPNESS_delta_T']]
BAE1['SPIKE_TRIGGERED_ADAPTATION_INCREMENT_b'] = [0.75 * BAE1['SPIKE_TRIGGERED_ADAPTATION_INCREMENT_b'], 1.5 * BAE1['SPIKE_TRIGGERED_ADAPTATION_INCREMENT_b']]
BAE1['V_RESET'] = [0.75 * BAE1['V_RESET'], 1.5 * BAE1['V_RESET']]
BAE1['V_REST'] = [0.75 * BAE1['V_REST'], 1.5 * BAE1['V_REST']]
