...
class AllenTest(VmTest):
    ...
    def set_observation(self,value):
        self.observation = {}
        self.observation['mean'] = np.mean(value)
        self.observation['std'] = np.abs(np.mean(value))


    # @prediction.setter
    def set_prediction(self,value):
        self.prediction = {}
        self.prediction['mean'] = np.mean(value)
        self.prediction['std'] = np.abs(np.mean(value))
