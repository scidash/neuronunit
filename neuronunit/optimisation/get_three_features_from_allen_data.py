...
def get_static_models_allen(content):
    ...
    supra_numbers = [s['sweep_number'] for s in supras]
    #print(supra_numbers)
    #data_set.get_sweep(data_set.get_sweep_numbers()[supra_numbers]))
    injections = [ data_set.get_sweep(sn) for sn in supra_numbers ]
    pickle.dump(injections,open('generic_injections','wb'))
