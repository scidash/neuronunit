...
for q in quads:
    ...
    vmpop1 , _ = eam.check_rheobase(vmpop1)
    ...
    import copy
    efitnesses = dview.map_sync(eam.evaluate, copy.copy(vmpop1))
...
print('get s here?')
_ = map(pair2surface,one)
_ = map(pair2surface,two)
_ = map(pair2surface,three)
_ = map(pair2surface,four)
'''
for q in two:
