...
class Druckmann2013BaseTestCase:
    class BaseTest(unittest.TestCase):
        ...
        def setUp(self):
            ...
            self.ir_currents = (
                self.model.nmldb_model.get_druckmann2013_input_resistance_currents()
            )

            self.test_set = [
                {
                    "test": AP12AmplitudeDropTest(self.standard),
                    "units": pq.mV,
                    "expected": None,
                },
                {
                    "test": AP1SSAmplitudeChangeTest(self.standard),
                    "units": pq.mV,
                    "expected": None,
                },
                {
                    "test": AP1AmplitudeTest(self.standard),
                    "units": pq.mV,
                    "expected": None,
                },
                {
                    "test": AP1WidthHalfHeightTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": AP1WidthPeakToTroughTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": AP1RateOfChangePeakToTroughTest(self.standard),
                    "units": pq.mV / pq.ms,
                    "expected": None,
                },
                {
                    "test": AP1AHPDepthTest(self.standard),
                    "units": pq.mV,
                    "expected": None,
                },
                {
                    "test": AP2AmplitudeTest(self.standard),
                    "units": pq.mV,
                    "expected": None,
                },
                {
                    "test": AP2WidthHalfHeightTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": AP2WidthPeakToTroughTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": AP2RateOfChangePeakToTroughTest(self.standard),
                    "units": pq.mV / pq.ms,
                    "expected": None,
                },
                {
                    "test": AP2AHPDepthTest(self.standard),
                    "units": pq.mV,
                    "expected": None,
                },
                {
                    "test": AP12AmplitudeChangePercentTest(self.standard),
                    "units": None,
                    "expected": None,
                },
                {
                    "test": AP12HalfWidthChangePercentTest(self.standard),
                    "units": None,
                    "expected": None,
                },
                {
                    "test": AP12RateOfChangePeakToTroughPercentChangeTest(
                        self.standard
                    ),
                    "units": None,
                    "expected": None,
                ...
                {
                    "test": AP12AHPDepthPercentChangeTest(self.standard),
                    "units": None,
                    "expected": None,
                },
                {
                    "test": InputResistanceTest(injection_currents=self.ir_currents),
                    "units": pq.Quantity(1, "MOhm"),
                    "expected": None,
                },
                {
                    "test": AP1DelayMeanTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": AP1DelaySDTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": AP2DelayMeanTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": AP2DelaySDTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": Burst1ISIMeanTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": Burst1ISISDTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": InitialAccommodationMeanTest(self.standard),
                    "units": None,
                    "expected": None,
                },
                {
                    "test": SSAccommodationMeanTest(self.standard),
                    "units": None,
                    "expected": None,
                },
                {
                    "test": AccommodationRateToSSTest(self.standard),
                    "units": 1 / pq.ms,
                    "expected": None,
                },
                {
                    "test": AccommodationAtSSMeanTest(self.standard),
                    "units": None,
                    "expected": None,
                },
                {
                    "test": AccommodationRateMeanAtSSTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {"test": ISICVTest(self.standard), "units": None, "expected": None},
                {
                    "test": ISIMedianTest(self.standard),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": ISIBurstMeanChangeTest(self.standard),
                    "units": None,
                    "expected": None,
                },
                {
                    "test": SpikeRateStrongStimTest(self.strong),
                    "units": pq.Hz,
                    "expected": None,
                },
                {
                    "test": AP1DelayMeanStrongStimTest(self.strong),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": AP1DelaySDStrongStimTest(self.strong),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": AP2DelayMeanStrongStimTest(self.strong),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": AP2DelaySDStrongStimTest(self.strong),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": Burst1ISIMeanStrongStimTest(self.strong),
                    "units": pq.ms,
                    "expected": None,
                },
                {
                    "test": Burst1ISISDStrongStimTest(self.strong),
                    "units": pq.ms,
                    "expected": None,
                },
            ]
        ...
        def get_model(self):
            ...
            if self.model_id not in self.__class__.model_cache:
                print(
                    "Model " + self.model_id + " not in cache. Downloading waveforms..."
                )
                self.__class__.model_cache[self.model_id] = NeuroMLDBStaticModel(
                    self.model_id
                )

            if self.model_id not in self.__class__.predicted:
                self.__class__.predicted[self.model_id] = [
                    None for i in range(38)
                ]  # There are 38 tests
            ...
            for model_id in cls.predicted.keys():
                ...
                for i, p in enumerate(cls.predicted[model_id]):
                    if p["predicted"] is not None:
                        print(
                            "             "
                            + str((p["predicted"] * dimensionless).magnitude).rjust(25)
                            + ", # "
                            + p["test"]
                        )
                    else:
