	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 h /cygdrive/c/Users/Saci/Dokumentumok/szakmai gyak/Ca1_Bianchi/Ca1_Bianchi/experiment/h.mod\n");
...
static int  states ( _p, _ppvar, _thread, _nt ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; {
   if ( v > - 30.0 ) {
     ...
     taun = 5.0 * ( 1.0 / ( exp ( ( v + 145.0 ) / - 17.5 ) + exp ( ( v + 16.8 ) / 16.5 ) ) + 5.0 ) ;
     }
