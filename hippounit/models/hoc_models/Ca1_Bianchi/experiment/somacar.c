	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 somacar /cygdrive/c/Users/Saci/Dokumentumok/szakmai gyak/Ca1_Bianchi/Ca1_Bianchi/experiment/somacar.mod\n");
...
double vartau ( _p, _ppvar, _thread, _nt, _li ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _li ;
 {
   double _lvartau;
 if ( _li  == 0.0 ) {
