	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 nax /cygdrive/c/Users/Saci/Dokumentumok/szakmai gyak/dichotomy/fig08/nax.mod\n");
...
static int  trates ( _p, _ppvar, _thread, _nt, _lvm ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lvm ;
 {
   double _la , _lb , _lqt ;
