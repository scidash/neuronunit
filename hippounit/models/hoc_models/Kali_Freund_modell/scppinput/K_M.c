...
extern int nrn_get_mechtype();
 ...
 "setdata_K_M", _hoc_setdata,
 "rates_K_M", _hoc_rates,
 0, 0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 K_M /cygdrive/c/Documents and Settings/Saci/Desktop/NEURON 7.2/scppinput/K_M.mod\n");
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
  ...
  _ltemp_adj_X = 1.0 ;
   _lv = _lv * 0.0010 ;
   _ltau = ( 1.0 / ( ( 5.0 * ( exp ( 0.8 * ( _lv - ( - 0.018 ) ) / 0.003 ) ) ) + ( 5.0 * ( exp ( ( 0.8 - 1.0 ) * ( _lv - ( - 0.018 ) ) / 0.003 ) ) ) ) + 0.02 ) ;
   _ltau = _ltau * 1000.0 ;
   _lv = _lv * 1000.0 ;
