...
#define Deadtime Deadtime_NMDA_dsyn
 double Deadtime = 0;
#define Prethresh Prethresh_NMDA_dsyn
 double Prethresh = 0;
#define usetable usetable_NMDA_dsyn
 double usetable = 1;
#define vmax vmax_NMDA_dsyn
 double vmax = 100;
#define vmin vmin_NMDA_dsyn
 double vmin = -120;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_NMDA_dsyn", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "Prethresh_NMDA_dsyn", "mV",
 "Deadtime_NMDA_dsyn", "ms",
 "vmin_NMDA_dsyn", "mV",
 "vmax_NMDA_dsyn", "mV",
 "gmax", "nS",
 "tau1", "ms",
 ...
 "Prethresh_NMDA_dsyn", &Prethresh_NMDA_dsyn,
 "Deadtime_NMDA_dsyn", &Deadtime_NMDA_dsyn,
 "vmin_NMDA_dsyn", &vmin_NMDA_dsyn,
 "vmax_NMDA_dsyn", &vmax_NMDA_dsyn,
 "usetable_NMDA_dsyn", &usetable_NMDA_dsyn,
 0,0
};
	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_dsyn /cygdrive/d/SkyDrive/Dokumentumok/ITK MSc/CA1_piramissejt_dendrit/Modellek/Kali_Freund_modell/scppinput/nmda_dsyn.mod\n");
...
/*CVODE*/
 ...
 static mgblock(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv) { 
#if 0
_check_mgblock(_p, _ppvar, _thread, _nt);
#endif
 ...
 static _n_mgblock(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv){ int _i, _j;
 double _xi, _theta;
 if (!usetable) {
...
static int  _f_mgblock ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
   mgB = 1.0 / ( 1.0 + 0.1 * exp ( - 0.1 * ( _lv ) ) ) ;
    return 0; }
