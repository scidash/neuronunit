...
extern int nrn_get_mechtype();
 ...
 "setdata_Na_soma13", _hoc_setdata,
 "rates_Na_soma13", _hoc_rates,
 0, 0
};
...
#define usetable usetable_Na_soma13
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Na_soma13", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_Na_soma13", "S/cm2",
 "gion_Na_soma13", "S/cm2",
 "Xtau_Na_soma13", "ms",
 "Ytau_Na_soma13", "ms",
 "Ztau_Na_soma13", "ms",
 0,0
 ...
 "usetable_Na_soma13", &usetable_Na_soma13,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 Na_soma13 /cygdrive/c/Documents and Settings/Saci/Desktop/NEURON 7.2/scppinput/Na_soma13.mod\n");
