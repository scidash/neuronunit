...
extern int nrn_get_mechtype();
 ...
 "setdata_K_M2", _hoc_setdata,
 "rates_K_M2", _hoc_rates,
 0, 0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 K_M2 /cygdrive/d/SkyDrive/Dokumentumok/ITK MSc/CA1_piramissejt_dendrit/Kali_Freund_modell/scppinput/K_M2.mod\n");
...
static int _reset;
static char *modelname = "Channel: K_M";
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
  ...
  _ltemp_adj_X = 1.0 ;
   _lv = _lv * 0.0010 ;
   _ltau = ( 1.0 / ( ( 5.0 * ( exp ( 0.8 * ( _lv - ( - 0.018 ) ) / 0.003 ) ) ) + ( 5.0 * ( exp ( ( 0.8 - 1.0 ) * ( _lv - ( - 0.018 ) ) / 0.003 ) ) ) ) + 0.002 ) ;
   _ltau = _ltau * 1000.0 ;
   _lv = _lv * 1000.0 ;
   Xtau = _ltau / _ltemp_adj_X ;
   _lv = _lv * 0.0010 ;
   _linf = ( ( 5.0 * ( exp ( 0.8 * ( _lv - ( - 0.018 ) ) / 0.003 ) ) ) / ( ( 5.0 * ( exp ( 0.8 * ( _lv - ( - 0.018 ) ) / 0.003 ) ) ) + ( 5.0 * ( exp ( ( 0.8 - 1.0 ) * ( _lv - ( - 0.018 ) ) / 0.003 ) ) ) ) ) ;
   _lv = _lv * 1000.0 ;
   Xinf = _linf ;
    return 0; }
