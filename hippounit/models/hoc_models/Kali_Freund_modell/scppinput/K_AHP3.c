	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 K_AHP3 /cygdrive/c/Documents and Settings/Saci/Desktop/NEURON 7.2/scppinput/K_AHP3.mod\n");
...
static int  settables ( _p, _ppvar, _thread, _nt, _lv , _lcai ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv , _lcai ;
 {
