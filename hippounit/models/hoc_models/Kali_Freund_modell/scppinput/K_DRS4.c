...
extern int nrn_get_mechtype();
 ...
 "setdata_K_DRS4", _hoc_setdata,
 "rates_K_DRS4", _hoc_rates,
 0, 0
};
...
#define usetable usetable_K_DRS4
 double usetable = 1;
 ...
 "usetable_K_DRS4", &usetable_K_DRS4,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 K_DRS4 /cygdrive/c/Documents and Settings/Saci/Desktop/NEURON 7.2/scppinput/K_DRS4.mod\n");
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
  ...
  _ltemp_adj_X = 1.0 ;
   ...
   _linf = 1.0 / ( 1.0 + exp ( - ( _lv + 0.02 ) / 0.015 ) ) ;
   _lv = _lv * 1000.0 ;
   Xinf = _linf ;
    return 0; }
