...
#define _f_mgblock _f_mgblock_NMDA_M
#define mgblock mgblock_NMDA_M
...
#define usetable usetable_NMDA_M
 double usetable = 1;
 ...
 "usetable_NMDA_M", &usetable_NMDA_M,
 0,0
};
	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_M /cygdrive/d/SkyDrive/Dokumentumok/ITK MSc/CA1_piramissejt_dendrit/Modellek/Kali_Freund_modell/scppinput/NMDA_M.mod\n");
...
double _f_mgblock ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
   double _lmgblock;
 _lmgblock = 1.0 / ( 1.0 + exp ( 0.08 * - _lv ) * ( mg / 5.0 ) ) ;
