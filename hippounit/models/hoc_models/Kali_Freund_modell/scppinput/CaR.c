	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 CaR /cygdrive/c/Documents and Settings/Saci/Desktop/NEURON 7.2/scppinput/CaR.mod\n");
...
static int _reset;
static char *modelname = "Channel: CaR";
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
  ...
  _ltemp_adj_X = 1.0 ;
   ...
   _lv = _lv * 0.0010 ;
   _ltau = ( 1.0 / ( ( 10.0 * ( exp ( 0.5 * ( _lv + 0.053 ) / ( - 0.009 ) ) ) ) + ( 10.0 * ( exp ( ( 0.5 - 1.0 ) * ( _lv + 0.053 ) / ( - 0.009 ) ) ) ) ) + 0.02 ) ;
   _ltau = _ltau * 1000.0 ;
   _lv = _lv * 1000.0 ;
   Ytau = _ltau / _ltemp_adj_Y ;
   _lv = _lv * 0.0010 ;
   _linf = ( ( 10.0 * ( exp ( 0.5 * ( _lv + 0.053 ) / ( - 0.009 ) ) ) ) / ( ( 10.0 * ( exp ( 0.5 * ( _lv + 0.053 ) / ( - 0.009 ) ) ) ) + ( 10.0 * ( exp ( ( 0.5 - 1.0 ) * ( _lv + 0.053 ) / ( - 0.009 ) ) ) ) ) ) ;
   _lv = _lv * 1000.0 ;
   Yinf = _linf ;
    return 0; }
