	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 CaN /cygdrive/c/Documents and Settings/Saci/Desktop/NEURON 7.2/scppinput/CaN.mod\n");
