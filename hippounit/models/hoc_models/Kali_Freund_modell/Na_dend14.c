...
extern int nrn_get_mechtype();
 ...
 "setdata_Na_dend14", _hoc_setdata,
 "rates_Na_dend14", _hoc_rates,
 0, 0
};
...
#define usetable usetable_Na_dend14
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Na_dend14", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_Na_dend14", "S/cm2",
 "gion_Na_dend14", "S/cm2",
 "Xtau_Na_dend14", "ms",
 "Ytau_Na_dend14", "ms",
 "Ztau_Na_dend14", "ms",
 0,0
 ...
 "usetable_Na_dend14", &usetable_Na_dend14,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 Na_dend14 /cygdrive/d/SkyDrive/Dokumentumok/ITK MSc/CA1_piramissejt_dendrit/Modellek/Kali_Freund_modell/scppinput/Na_dend14.mod\n");
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
  ...
  _ltemp_adj_X = 1.0 ;
   ...
   _lv = _lv * 0.0010 ;
   _ltau = ( 1.0 / ( ( 300.0 * ( exp ( 0.2 * ( _lv + 0.041 ) / ( - 0.005 ) ) ) ) + ( 300.0 * ( exp ( ( 0.2 - 1.0 ) * ( _lv + 0.041 ) / ( - 0.005 ) ) ) ) ) + 0.0001 ) ;
   _ltau = _ltau * 1000.0 ;
   _lv = _lv * 1000.0 ;
   Ytau = _ltau / _ltemp_adj_Y ;
   _lv = _lv * 0.0010 ;
   _linf = 1.0 / ( 1.0 + exp ( - ( _lv + 0.041 ) / ( - 0.003 ) ) ) ;
   _lv = _lv * 1000.0 ;
   Yinf = _linf ;
   _lv = _lv * 0.0010 ;
