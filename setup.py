...
setup(
    ...
    long_description="",
    install_requires=['scipy>=0.17','matplotlib>=1.5','neo==0.4','elephant','sciunit==0.1.5.5','allensdk==0.12.4-py3.5'],
    dependency_links = ['https://github.com/scidash/sciunit/tarball/dev#egg=sciunit-0.1.5.5',
                        'https://github.com/rgerkin/AllenSDK/tarball/python3.5#egg=allensdk-0.12.4-py3.5']
)
